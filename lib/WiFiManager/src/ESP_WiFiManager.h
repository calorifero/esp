...
const char HTTP_STYLE[] PROGMEM = "<style>body,textarea,input,select{background: 0; border-radius: 0; font: 16px sans-serif; margin: 0}textarea,input,select{outline: 0; font-size: 14px; border: 1px solid #ccc; padding: 8px; width: 90%}.btn a{text-decoration: none}.container{margin: auto; width: 90%; flex-flow: column; display: flex; align-items: center; justify-content: center;}@media(min-width:1200px){.container{margin: auto;}}@media(min-width:768px) and (max-width:1200px){.container{margin: auto;}}h2{font-size: 2em}h1{font-size: 3em}.btn{background: #84F37B; border-radius: 1em; border: 0; font-size: 1.3em; color: black; cursor: pointer; padding: 0.4em;}form>*{border: solid 0.1em #84F37B; border-radius: 1em; margin-bottom: 0.5em; font-size: 1.1em;}textarea:focus,input:focus,select:focus{border-color: #5ab}.msg{background: #def; border-left: 5px solid #59d; padding: 1.5em}.q{float: right; width: 64px; text-align: right}input[type='checkbox']{float: center; width: 100%;}.table td{padding: .5em; text-align: left}.table tbody>:nth-child(2n-1){background: #ddd}</style>";
const char HTTP_SCRIPT[] PROGMEM = "<script>function c(l){document.getElementById('s').value=l.innerText||l.textContent;document.getElementById('p').focus();}</script>";
const char HTTP_HEAD_END[] PROGMEM = "</head><body><div class=\"container\">";
const char HTTP_PORTAL_OPTIONS[] PROGMEM = "<form action=\"/wifi\" method=\"get\"><button class=\"btn\">Configurazione wifi</button></form><br/><form action=\"/i\" method=\"get\"><button class=\"btn\">Information</button></form><br/><form action=\"/close\" method=\"get\"><button class=\"btn\">Exit Portal</button></form><br/>";
const char HTTP_ITEM[] PROGMEM = "<div><a href=\"#p\" onclick=\"c(this)\">{v}</a>&nbsp;<span class=\"q {i}\">{r}%</span></div>";
const char JSON_ITEM[] PROGMEM = "{\"SSID\":\"{v}\", \"Encryption\":{i}, \"Quality\":\"{r}\"}";
const char HTTP_FORM_START[] PROGMEM = "<form method=\"get\" action=\"wifisave\"><input id=\"s\" name=\"s\" length=32 placeholder=\"SSID\"><input id=\"p\" name=\"p\" length=64 placeholder=\"password\">";
...
const char HTTP_FORM_END[] PROGMEM = "<button class=\"btn\" type=\"submit\">Salva</button></form>";
const char HTTP_SAVED[] PROGMEM = "<div class=\"msg\"><strong>Credenziali salvate</strong></div>";
